...
class CommentsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Movie_Genre:: create(array(    
            'id_movies' => '1',
            'id_client' => '3',
            'dateComment' => \Carbon\Carbon::create(2019, 1, 12),
            'rate' => '5',
        ...
        Movie_Genre:: create(array(    
            'id_movies' => '2',
            'id_client' => '1',
            'dateComment' => \Carbon\Carbon::create(2019, 1, 13),
            'rate' => '2',
        ...
        Movie_Genre:: create(array(    
            'id_movies' => '3',
            'id_client' => '3',
            'dateComment' => \Carbon\Carbon::create(2019, 1, 14),
            'rate' => '3',
        ...
        Movie_Genre:: create(array(    
            'id_movies' => '4',
            'id_client' => '1',
            'dateComment' => \Carbon\Carbon::create(2019, 1, 15),
            'rate' => '4',
        ...
        Movie_Genre:: create(array(    
            'id_movies' => '5',
            'id_client' => '2',
            'dateComment' => \Carbon\Carbon::create(2019, 1, 10),
            'rate' => '5',
        ...
        Movie_Genre:: create(array(    
            'id_movies' => '6',
            'id_client' => '3',
            'dateComment' => \Carbon\Carbon::create(2019, 1, 11),
            'rate' => '4',
